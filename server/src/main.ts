...
async function initializeTransport(): Promise<StreamableHTTPServerTransport> {
...
const mcpPostHandler = async (req: Request, res: Response) => {
    ...
    try {
        const isInitRequest = isInitializeRequest(req.body) || (req.body && (req.body as any).method === 'initialize');
        let transport: StreamableHTTPServerTransport;
        ...
        if (!sessionId && isInitRequest) {
            ...
            if (transport.sessionId) {
                ...
                (transport as any).sessionId = fallbackSid;
